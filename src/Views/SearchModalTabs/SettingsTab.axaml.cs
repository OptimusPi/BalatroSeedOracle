...
namespace BalatroSeedOracle.Views.SearchModalTabs
{
    public partial class SettingsTab : UserControl
    {
        ...
        {
            if (e.PropertyName == nameof(SearchModalViewModel.SelectedDeckIndex) ||
        ...
        private string GetDeckDescription(string deckName)
        {
            ...
            return deckName switch
            {
                ...
                "Plasma Deck" => "Balance Chips and Mult when calculating score for played hand. Base Chips and Mult set to stake Ante × 4",
