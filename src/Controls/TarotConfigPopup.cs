...
{
    /// <summary>
    /// Configuration popup specifically for Tarot card items
    /// </summary>
    public partial class TarotConfigPopup : ItemConfigPopupBase
    {
        ...
        private StackPanel BuildUI()
        {
            ...
            // Sources section - no Edition for Tarot cards
        ...
        private Border CreateSourcesSection()
        {
            ...
            _sourcePack = CreateSourceCheckBox("From Arcana Pack", "pack");
        ...
        protected override void LoadConfiguration(ItemConfig? config)
        {
            ...
            // Tarot cards don't have editions, so skip edition loading
