...
{
    /// <summary>
    /// Desktop DuckDB service implementation using DuckDB.NET.Data.
    /// Native DuckDB with full file system access.
    /// Supports both standard DuckDB connections and DuckLake (multiplayer mode).
    /// </summary>
    public sealed class DesktopDuckDBServiceNative : IDuckDBService
    {
