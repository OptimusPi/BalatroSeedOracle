...
namespace BalatroSeedOracle.Helpers
{
    ...
    public static class JsonAutocompletionHelper
    {
        ...
        private static void AddPropertyNameCompletions(List<ICompletionData> completions)
        {
            ...
            completions.Add(
                new SmartCompletionData(
                    "type",
                    "\"type\": \"Joker\"",
                    "Item type (Joker, TarotCard, SpectralCard, etc.)",
                    priority: 10
                )
            );
            completions.Add(
            ...
            completions.Add(
                new SmartCompletionData(
                    "min",
                    "\"min\": 2",
                    "Minimum occurrences required (NEW!)",
                    priority: 8
                )
            );
            completions.Add(
                new SmartCompletionData(
                    "edition",
                    "\"edition\": \"Negative\"",
                    "Edition requirement (Negative, Polychrome, etc.)",
                    priority: 7
                )
            );
            completions.Add(
        ...
        {
            completions.Add(
                new SmartCompletionData("Joker", "Joker", "Regular jokers", priority: 10)
            );
            completions.Add(
                new SmartCompletionData(
                    "SoulJoker",
                    "SoulJoker",
                    "Soul jokers (from spectral packs)",
                    priority: 10
                )
            );
            completions.Add(
            ...
            completions.Add(
                new SmartCompletionData("PlanetCard", "PlanetCard", "Planet cards", priority: 9)
            );
        ...
        )
        {
            ...
            completions.Add(
                new SmartCompletionData("anyrare", "anyrare", "Any rare joker", priority: 10)
            );
            completions.Add(
                new SmartCompletionData(
                    "anyuncommon",
            ...
            completions.Add(
                new SmartCompletionData("anycommon", "anycommon", "Any common joker", priority: 10)
            );
            completions.Add(
                new SmartCompletionData("anyjoker", "anyjoker", "Any joker at all", priority: 10)
            );
        ...
        {
            completions.Add(
                new SmartCompletionData("Negative", "Negative", "+1 joker slot", priority: 10)
            );
            completions.Add(
                new SmartCompletionData("Polychrome", "Polychrome", "x1.5 mult", priority: 9)
            );
            completions.Add(
                new SmartCompletionData("Holographic", "Holographic", "+10 mult", priority: 8)
            );
