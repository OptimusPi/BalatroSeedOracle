# Properly create multi-size ICO from PNG using magick (ImageMagick) or fallback .NET
$pngPath = "X:\BalatroSeedOracle\src\BalatroSeedOracle\BalatroSeedOracle-App-Icon.png"
$icoPath = "X:\BalatroSeedOracle\src\BalatroSeedOracle\BalatroSeedOracle.ico"
