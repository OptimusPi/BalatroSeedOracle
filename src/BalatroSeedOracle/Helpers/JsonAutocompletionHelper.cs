...
namespace BalatroSeedOracle.Helpers
{
    ...
    public static class JsonAutocompletionHelper
    {
        ...
        private static void AddPropertyNameCompletions(List<ICompletionData> completions, bool insideCriteriaObject)
        {
            ...
            completions.Add(new SmartCompletionData("type", "\"type\": \"Joker\"", "Item type", priority: 10));
            completions.Add(
                new SmartCompletionData("value", "\"value\": \"Blueprint\"", "Single item value", priority: 9)
            );
            completions.Add(
                new SmartCompletionData(
                    "values",
            ...
            completions.Add(new SmartCompletionData("min", "\"min\": 2", "Minimum occurrences", priority: 8));
            completions.Add(new SmartCompletionData("score", "\"score\": 1", "Priority score", priority: 8));
            completions.Add(
                new SmartCompletionData("edition", "\"edition\": \"Negative\"", "Edition requirement", priority: 7)
            );
            completions.Add(
                new SmartCompletionData("antes", "\"antes\": [1, 2, 3, 4, 5, 6, 7, 8]", "Antes to check", priority: 7)
            );
            completions.Add(
                new SmartCompletionData(
                    "sources",
            ...
            completions.Add(
                new SmartCompletionData("packSlots", "\"packSlots\": [0, 1, 2, 3]", "Pack slot positions", priority: 6)
            );
            completions.Add(new SmartCompletionData("tags", "\"tags\": true", "Include tags", priority: 6));
            completions.Add(new SmartCompletionData("minShopSlot", "\"minShopSlot\": 0", "Min shop slot", priority: 5));
            completions.Add(
                new SmartCompletionData("maxShopSlot", "\"maxShopSlot\": 10", "Max shop slot", priority: 5)
            );
            completions.Add(new SmartCompletionData("minPackSlot", "\"minPackSlot\": 0", "Min pack slot", priority: 5));
            completions.Add(new SmartCompletionData("maxPackSlot", "\"maxPackSlot\": 6", "Max pack slot", priority: 5));

            // Filter structure
            completions.Add(new SmartCompletionData("must", "\"must\": []", "AND logic", priority: 10));
            completions.Add(new SmartCompletionData("should", "\"should\": []", "OR logic", priority: 10));
            completions.Add(new SmartCompletionData("mustNot", "\"mustNot\": []", "NOT logic", priority: 10));

            // Top-level metadata
            completions.Add(new SmartCompletionData("deck", "\"deck\": \"Red\"", "Starting deck", priority: 6));
            completions.Add(new SmartCompletionData("stake", "\"stake\": \"White\"", "Stake", priority: 6));
            completions.Add(new SmartCompletionData("name", "\"name\": \"MyFilter\"", "Filter name", priority: 6));
            completions.Add(new SmartCompletionData("author", "\"author\": \"pifreak\"", "Author", priority: 5));
            completions.Add(
                new SmartCompletionData(
                    "description",
        ...
        private static void AddTypeValueCompletions(List<ICompletionData> completions)
        {
            ...
            completions.Add(new SmartCompletionData("SoulJoker", "SoulJoker", "Soul jokers", priority: 8));
